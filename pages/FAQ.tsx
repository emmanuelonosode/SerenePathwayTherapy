    ...
    return (
        <PageWrapper title="Your Questions Answered" subtitle="Find answers to common questions about therapy, logistics, and what to expect on your journey.">
            <div className="max-w-4xl mx-auto space-y-16">
                <section>
                    <h2 className="text-2xl font-bold font-serif text-charcoal mb-6 border-b-2 border-deep-sage/50 pb-2">Getting Started with Therapy</h2>
                    <Accordion items={mainFaqs.preTherapy} />
                </section>
                <section>
                    <h2 className="text-2xl font-bold font-serif text-charcoal mb-6 border-b-2 border-deep-sage/50 pb-2">Practical Questions</h2>
                    <Accordion items={mainFaqs.practical} />
                </section>
                <section>
                    <h2 className="text-2xl font-bold font-serif text-charcoal mb-6 border-b-2 border-deep-sage/50 pb-2">Confidentiality & Privacy</h2>
                    <Accordion items={mainFaqs.confidentiality} />
                </section>
                <section>
                    <h2 className="text-2xl font-bold font-serif text-charcoal mb-6 border-b-2 border-deep-sage/50 pb-2">Session Logistics</h2>

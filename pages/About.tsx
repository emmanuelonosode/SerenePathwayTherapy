            ...
            <div className="max-w-4xl mx-auto">
                ...
                <section className="mb-16 grid md:grid-cols-3 gap-12 items-center">
                    <div className="md:col-span-1 flex justify-center">
                        <img src="https://images.unsplash.com/photo-1580429715492-75924d732895?q=80&w=400&h=400&auto=format&fit=crop&crop=faces" alt="Dr. Anya Sharma in her office" className="rounded-full shadow-xl w-64 h-64 object-cover" />
                    </div>
                    <div className="md:col-span-2">
                        <h2 className="text-3xl font-bold font-serif text-text-primary mb-4">My Journey to Becoming a Therapist</h2>
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-bold font-serif text-text-primary mb-8 text-center">Credentials & Therapeutic Approach</h2>
                ...
                <section className="text-center">
                    <h2 className="text-3xl font-bold font-serif text-text-primary mb-4">My Philosophy</h2>
                    <p className="text-lg text-text-primary/80 max-w-3xl mx-auto leading-relaxed">
